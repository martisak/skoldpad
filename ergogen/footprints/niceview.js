    ...
    body: p => {
        ...
        function outline() {
            return `
              ...
              ${'' /* labels */}
              (fp_text user Nice!View (at -2.5 0.00 ${p.rot+90}) (layer F.SilkS knockout) (effects (font (face "${p.font}") (size 0.8 0.8) (thickness 0.15))))
              (fp_text user Nice!View (at -2.5 0.00 ${p.rot+90}) (layer B.SilkS knockout) (effects (font (face "${p.font}") (size 0.8 0.8) (thickness 0.15)) (justify mirror)))
