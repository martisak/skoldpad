module.exports = {
    ...
    body: p => `
        (footprint "Diode_SMD:Nexperia_CFP3_SOD-123W"
            ...
            (tags "CFP3 SOD-123W")
            (attr smd)
            (fp_text reference "${p.ref}" (at 0 -2 ${p.r}) (layer "F.SilkS") ${p.ref_hide}
                (effects (font (size 1 1) (thickness 0.15)))
            )
            (fp_text value "Nexperia_CFP3_SOD-123W" (at 0 2 ${p.r}) (layer "F.Fab") hide
                (effects (font (size 1 1) (thickness 0.15)))
            )
            ...
            (fp_line (start 1.3 -0.85) (end 1.3 0.85) (stroke (width 0.1) (type solid)) (layer "B.Fab"))
            (fp_line (start 1.3 0.85) (end -1.3 0.85) (stroke (width 0.1) (type solid)) (layer "B.Fab"))
            (pad "1" thru_hole rect (at -1.4 0 ${p.r}) (size 1.2 1.2) (drill 0.3) (layers *.Cu *.Mask) (zone_connect 2) ${p.to})
            (pad "2" thru_hole rect (at 1.4 0 ${p.r}) (size 1.2 1.2) (drill 0.3) (layers *.Cu *.Mask) (zone_connect 2) ${p.from})
        )
    `
}
