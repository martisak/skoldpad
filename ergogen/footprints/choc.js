// Kailh Choc PG1350 -- syntax-modernized copy of ergogen's own built-in
// choc footprint (node_modules/ergogen/src/footprints/choc.js). Geometry
// is byte-identical to the built-in; only the KiCad 6+ syntax changed
// (footprint keyword, quoted layers, stroke blocks instead of bare
// width). Ergogen's local-footprint injection overwrites the built-in
// entry with this file by name, so config.yaml's `what: choc` picks
