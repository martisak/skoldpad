// Button_Switch_SMD:SW_SPDT_PCM12, geometry matches the official KiCad
// footprint library (Button_Switch_SMD.pretty) verbatim on the front side;
// the back-side copy is an X-mirrored duplicate so the switch keeps working
// after the board is fabricated mirrored for the other hand.
module.exports = {
    params: {
        designator: 'T',
    ...
    body: p => `
        (footprint "Button_Switch_SMD:SW_SPDT_PCM12"
            ...
            (pad "" np_thru_hole circle (at 1.5 0.33 ${p.r}) (size 0.9 0.9) (drill 0.9) (layers "*.Cu" "*.Mask"))
            (pad 1 smd rect (at -2.25 -1.43 ${p.r}) (size 0.7 1.5) (layers "F.Cu" "F.Paste" "F.Mask") ${p.from})

            (pad 2 smd rect (at 0.75 -1.43 ${p.r}) (size 0.7 1.5) (layers "F.Cu" "F.Paste" "F.Mask") ${p.to})
            (pad "" smd rect (at 2.25 -1.43 ${p.r}) (size 0.7 1.5) (layers "F.Cu" "F.Paste" "F.Mask"))
            (pad "" smd rect (at -3.65 1.43 ${p.r}) (size 1 0.8) (layers "F.Cu" "F.Paste" "F.Mask"))
            (pad "" smd rect (at 3.65 1.43 ${p.r}) (size 1 0.8) (layers "F.Cu" "F.Paste" "F.Mask"))
            (pad "" smd rect (at 3.65 -0.78 ${p.r}) (size 1 0.8) (layers "F.Cu" "F.Paste" "F.Mask"))
            (pad "" smd rect (at -3.65 -0.78 ${p.r}) (size 1 0.8) (layers "F.Cu" "F.Paste" "F.Mask"))

            (pad "" np_thru_hole circle (at -1.5 0.33 ${p.r}) (size 0.9 0.9) (drill 0.9) (layers "*.Cu" "*.Mask"))
            (pad "" np_thru_hole circle (at 1.5 0.33 ${p.r}) (size 0.9 0.9) (drill 0.9) (layers "*.Cu" "*.Mask"))
            (pad 1 smd rect (at 2.25 -1.43 ${p.r}) (size 0.7 1.5) (layers "B.Cu" "B.Paste" "B.Mask") ${p.from})

            (pad 2 smd rect (at -0.75 -1.43 ${p.r}) (size 0.7 1.5) (layers "B.Cu" "B.Paste" "B.Mask") ${p.to})
            (pad "" smd rect (at -2.25 -1.43 ${p.r}) (size 0.7 1.5) (layers "B.Cu" "B.Paste" "B.Mask"))
            (pad "" smd rect (at 3.65 1.43 ${p.r}) (size 1 0.8) (layers "B.Cu" "B.Paste" "B.Mask"))
            (pad "" smd rect (at -3.65 1.43 ${p.r}) (size 1 0.8) (layers "B.Cu" "B.Paste" "B.Mask"))
            (pad "" smd rect (at -3.65 -0.78 ${p.r}) (size 1 0.8) (layers "B.Cu" "B.Paste" "B.Mask"))
            (pad "" smd rect (at 3.65 -0.78 ${p.r}) (size 1 0.8) (layers "B.Cu" "B.Paste" "B.Mask"))
